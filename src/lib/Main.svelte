...
<body class="bg-gradient-to-br from-blue-50 via-white to-cyan-50">
    ...
    <script type="module">
        import { mount } from 'https://unpkg.com/svelte@5/index.js';
        ...
        const Header = {
            template: `
                <header class="fixed top-0 w-full z-50 glass-effect border-b border-white/20">
                        ...
                        <div class="flex justify-between items-center h-16">
                            ...
                            <nav class="hidden md:flex space-x-8">
                                ...
                                <button onclick="currentSection = 'contact'" 
                                        class="bg-primary text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-all duration-300 animate-pulse-glow">
                                    Contact
                                </button>
                            </nav>
                    ...
                    <!-- Mobile Menu -->
                    <div class="md:hidden" style="display: ${menuOpen ? 'block' : 'none'}">
                        <div class="px-2 pt-2 pb-3 space-y-1 glass-effect">
                            <button onclick="currentSection = 'accueil'; menuOpen = false" class="block px-3 py-2 text-gray-700 hover:text-primary">Accueil</button>
                            <button onclick="currentSection = 'services'; menuOpen = false" class="block px-3 py-2 text-gray-700 hover:text-primary">Services</button>
                            <button onclick="currentSection = 'urgence'; menuOpen = false" class="block px-3 py-2 text-gray-700 hover:text-primary">Urgence 24h/7j</button>
                            <button onclick="currentSection = 'contact'; menuOpen = false" class="block px-3 py-2 text-gray-700 hover:text-primary">Contact</button>
                        </div>
                    </div>
                </header>
            `
                        ...
                        <div class="grid lg:grid-cols-2 gap-12 items-center">
                            <div class="animate-slide-up">
                                <h1 class="text-5xl lg:text-6xl font-bold mb-6">
                                    ...
                                    <span class="text-secondary">Chauffage</span>
                                </h1>
                                ...
                                <div class="flex flex-col sm:flex-row gap-4 mb-8">
                                    ...
                                    <button onclick="currentSection = 'services'" 
                                            class="bg-primary text-white px-8 py-4 rounded-xl font-semibold hover:bg-blue-700 transform hover:scale-105 transition-all duration-300">
                                        Voir nos services
                                    </button>
                                </div>
                                ...
                                <div class="grid grid-cols-3 gap-6 text-center">
                                    ...
                                    <div class="animate-float" style="animation-delay: 0.5s">
                                        <div class="text-3xl font-bold text-secondary">24h/7j</div>
                            ...
                            <div class="relative animate-fade-in">
                                <div class="glass-effect rounded-3xl p-8 transform hover:scale-105 transition-all duration-500">
                                    ...
                                    <form class="space-y-4" onsubmit="handleQuickQuote(event)">
                                        <select class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                                            ...
                                            ${services.map(service => `<option value="${service.id}">${service.nom}</option>`).join('')}
                                        </select>
                                        <input type="text" placeholder="Votre nom" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                                        <input type="tel" placeholder="Téléphone" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                                        <textarea placeholder="Décrivez votre problème..." class="w-full p-3 border border-gray-300 rounded-lg h-24 focus:ring-2 focus:ring-primary focus:border-transparent"></textarea>
                                        <button type="submit" class="w-full bg-gradient-to-r from-primary to-accent text-white py-3 rounded-lg font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-300">
                        ...
                        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ${services.map((service, index) => `
                                <div class="glass-effect rounded-2xl p-6 text-center transform hover:scale-105 transition-all duration-500 animate-slide-up" style="animation-delay: ${index * 0.1}s">
                                    ...
                                    <div class="text-lg font-semibold text-primary mb-4">${service.prix}</div>
                                    ${service.urgence ? '<span class="bg-red-100 text-red-600 px-3 py-1 rounded-full text-sm font-medium">Urgence</span>' : ''}
                                    <button onclick="selectedService = '${service.id}'; currentSection = 'contact'" class="mt-4 w-full bg-primary text-white py-2 rounded-lg hover:bg-blue-700 transition-colors">
                                        Demander un devis
                                    </button>
                                </div>
                            `).join('')}
                    ...
                    <div class="max-w-4xl mx-auto text-center">
                        <div class="bg-gradient-to-r from-red-500 to-orange-500 text-white rounded-3xl p-12 animate-pulse-glow">
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                                ...
                                <button onclick="currentSection = 'contact'" class="bg-yellow-400 text-red-500 px-8 py-4 rounded-xl font-bold hover:bg-yellow-300 transform hover:scale-105 transition-all duration-300">
                            ...
                            <div class="glass-effect rounded-3xl p-8 animate-slide-up">
                                ...
                                <form class="space-y-4" onsubmit="handleContactForm(event)">
                                    <div class="grid md:grid-cols-2 gap-4">
                                        <input type="text" placeholder="Nom *" required class="p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                                        <input type="tel" placeholder="Téléphone *" required class="p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                                    </div>
                                    <input type="email" placeholder="Email *" required class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                                    <input type="text" placeholder="Adresse d'intervention" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                                    
                                    <select class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                                        <option value="">Type d'intervention</option>
                                        ${services.map(service => `<option value="${service.id}" ${selectedService === service.id ? 'selected' : ''}>${service.nom}</option>`).join('')}
                                    </select>
                                    
                                    <textarea placeholder="Description détaillée du problème *" required class="w-full p-3 border border-gray-300 rounded-lg h-32 focus:ring-2 focus:ring-primary focus:border-transparent"></textarea>
                                    
                                    <div class="flex items-center space-x-2">
                                        <input type="checkbox" id="urgence" class="w-4 h-4 text-red-500 focus:ring-red-500">
                                        <label for="urgence" class="text-red-500 font-medium">Intervention d'urgence</label>
                                    </div>
                                    
                                    <button type="submit" class="w-full bg-gradient-to-r from-primary to-accent text-white py-4 rounded-lg font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-300">
                                        Envoyer ma demande
                                    </button>
                                </form>
                            </div>
                                    ...
                                    <div class="space-y-3">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-primary">01 23 45 67 89</div>
                                            </div>
                                        </div>
                                        <div class="flex items-center">
                                            <span class="text-2xl mr-3">📧</span>
                                            <div>
                                                ...
                                                <div class="text-primary">contact@plombipro.fr</div>
                                            </div>
                                        </div>
                                        <div class="flex items-center">
                                            <span class="text-2xl mr-3">📍</span>
                ...
                <footer class="bg-gray-900 text-white py-12">
                    <div class="max-w-7xl mx-auto px-4">
                        ...
                        <div class="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
                            <p>&copy; 2024 PlombiPro. Tous droits réservés. | Mentions légales | Politique de confidentialité</p>
                        </div>
                    </div>
                </footer>
            `
        ...
        const App = {
            template: `
                <div class="min-h-screen">
                    ...
                    <main>
                        ${currentSection === 'accueil' ? Hero.template : ''}
                        ${currentSection === 'services' ? Services.template : ''}
                        ${currentSection === 'urgence' ? Urgence.template : ''}
                        ${currentSection === 'contact' ? Contact.template : ''}
                    </main>
            ...
            setup() {
                ...
                $effect(() => {
                    ...
                    const titles = {
                        'accueil': 'PlombiPro - Plomberie et Chauffage',
                        'services': 'Nos Services - PlombiPro',
                        'urgence': 'Urgence 24h/7j - PlombiPro',
                        'contact': 'Contact - PlombiPro'
                    };
                    document.title = titles[currentSection] || 'PlombiPro';
                });
            }
        };
        ...
        window.handleQuickQuote = handleQuickQuote;
